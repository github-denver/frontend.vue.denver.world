  ...
  methods: {
    onSubmit(payload) {
      ...
      api
        ...
        .catch((error) => {
          console.log('[MemberCreatePage.vue] 회원가입에 실패했어요.. ㅠㅜ error: ', error) // prettier-ignore
          console.log('[MemberCreatePage.vue] 회원가입에 실패했어요.. ㅠㅜ error.message: ', error.message) // prettier-ignore
          console.log('[MemberCreatePage.vue] 회원가입에 실패했어요.. ㅠㅜ error.response: ', error.response) // prettier-ignore
          console.log('[MemberCreatePage.vue] 회원가입에 실패했어요.. ㅠㅜ error.response.data: ', error.response.data) // prettier-ignore
