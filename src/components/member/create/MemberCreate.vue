...
export default {
  ...
  methods: {
    onSubmit(payload) {
      console.log(
        '[MemberCreate.vue] methods() → onSubmit → payload: ',
        payload
      )
      ...
      api
        ...
        .then((response) => {
          console.log(
            '[MemberCreate.vue] 회원가입에 성공했어요! response: ',
            response
          )
        ...
        .catch((error) => {
          console.log(
            '[MemberCreate.vue] 회원가입에 실패했어요.. ㅠㅜ error: ',
            error
          )
          console.log(
            '[MemberCreate.vue] 회원가입에 실패했어요.. ㅠㅜ error.message: ',
            error.message
          )
          console.log(
            '[MemberCreate.vue] 회원가입에 실패했어요.. ㅠㅜ error.response: ',
            error.response
          )
          console.log(
            '[MemberCreate.vue] 회원가입에 실패했어요.. ㅠㅜ error.response.data: ',
            error.response.data
          )
