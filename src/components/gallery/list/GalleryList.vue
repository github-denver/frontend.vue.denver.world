<template>
  <div id="container">
    <div class="contents">
      ...
      <gallery-list2 v-if="loading" v-bind:number="number" v-bind:posts="posts" v-bind:category="category" />
...
export default {
  name: 'GalleryList',
  components: { Hgroup, GalleryList2, Pagination, Search, Loading, Empty, LinkRectangle },
  props: {
    service: {
      type: String,
      required: true
