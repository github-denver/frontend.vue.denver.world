...
<script>
import MainCarousel from '@/components/common/main/MainCarousel'
import MainCategory from '@/components/common/main/MainCategory'
import MainGallery from '@/components/common/main/MainGallery'
import MainCommunity from '@/components/common/main/MainCommunity'

import api from '@/api'

export default {
  name: 'Main',
  components: { MainCarousel, MainCategory, MainGallery, MainCommunity },
  data() {
    return {
      category: {
        loading: false,
